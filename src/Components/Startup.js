...
function Startup(){
    return(
        ...
        <div>
            ...
            <b>You must be an accredited Startup to join Startup Hub</b><br></br>
        </div>
        <div className="form_container">
            <form>
                <p>
                    What is your Legal Name of your Firm?
                </p>
        ...
        <div>
            <h2  className="heading">
                Step 2 of 3: Future Goals
            </h2>
            <b>Tell us more about why you want to join Startup Hub</b><br></br>
        </div>
        <div className="form_container">
            <form>
